...
def evolutionary_search(
    ...
    for gen in range(generations):
        ...
        for idx, cfg in enumerate(population):
            ...
            fitness, val_loss, ppl, train_time, tps = train_and_eval_short(
                cfg,
                lm_datasets,
                tokenizer,
                vocab_size,
            ...
            scored.append((fitness, cfg, val_loss, ppl, train_time, tps))
            print(
        ...
        best_f, best_cfg, best_loss, best_ppl, best_time, best_tps = scored[0]
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="ea",
        choices=["ea", "train_best", "train_manual"],
        help="ea = evolutionary search; train_best = train evolved config; "
             "train_manual = train baseline config",
    )
